...
Release Version: v1.0.1 ([http://www.bioconductor.org/packages/SAIGEgds](http://www.bioconductor.org/packages/SAIGEgds))
...
R CMD check SAIGEgds_1.0.1.tar.gz
R CMD INSTALL SAIGEgds_1.0.1.tar.gz
```
